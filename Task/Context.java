...
public class Context {
	...
	private static String CALENDAR_DATA = "{ \"Tasks\" : [] }";
	...
	private static Pair MESSAGE_CURRENT_PATH   = new Pair("Your current path is %s");
	...
	private static Pair WARNING_FILE_DOES_NOT_EXIST = new Pair("WARNING: No file at path. Doing FILEOPEN will create an empty file. Doing FILESAVE will save your calendar to path.");
	...
	private static Pair ERROR_MALFORMED_KEY    = new Pair("ERROR! File does not match expected format. Please specify a new file location.");
	private static Pair ERROR_FILE_IO          = new Pair("ERROR! Cannot read from specified file location. Please specify a new file location");
	...
	private static Pair HELP_PATH              = new Pair("  PATH          : path [absolute filepath] - filepath must include filename complete extension. If blank, displays current path.");
	private static Pair HELP_FILEOPEN          = new Pair("  FILEOPEN  : fileopen  - command opens file at your current path.");
	private static Pair HELP_FILESAVE          = new Pair("  FILESAVE   : filesave - command saves calendar to your current path.");
	...
	private static Pair HELP_EDIT_TASK         = new Pair("  EDIT           : edit [task-id] do \"[description]\" on [Date] from [startTime] to [endTime] by [deadlineTime] at \"[venue]\"      ");
	...
	public void setCalendarData(String jsonString) {
		CALENDAR_DATA = jsonString;
	}
	...
	public HashMap<String, Object> getDataModel() {
		...
		dataModel.put("jsonData", CALENDAR_DATA);
		dataModel.put("lastTaskId", TASKID);
		return dataModel;
	}
